...
def SHOAIB():
    ...
    print(f"\033[1;31m===================")
    print("")
    CYBER = input(f'\033[1;32m[•] YOUR CHOICE : ')
    if CYBER in ["1"]:
        main()
    if CYBER in ["2"]:
        os.system('exit')
def main():
    ...
    print('\033[1;31m[\033[1;96m•\033[1;31m] \033[1;32mCLONING LIMIT= 1000•2000•5000•10000•15000•50000')
    print ('\033[1;31m==================================================           ')
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=100) as CYBER:
        os.system('clear')
        print(logo)
        tl = str(len(user))
        print('\033[1;32m='*50)
